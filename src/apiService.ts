...
export const getWorkspaces = async (
  ...
  const url = `http://localhost:8002/api/v1/listWorkspaces`; // 替换为实际的 URL
...
export const createAnalysis = async (
  ...
  const url = `http://localhost:8002/api/v1/createAnalysis`; // 替换为实际的 URL
...
export const getAnalysisSummary = async (
  ...
  const url = `http://localhost:8002/api/v1/getAnalysisSummary`; // 替换为实际的 URL
...
export const getStatementDetails = async (
  ...
  const url = `http://localhost:8002/api/v1/getStatementDetails`; // 替换为实际的 URL
